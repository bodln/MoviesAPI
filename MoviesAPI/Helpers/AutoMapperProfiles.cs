...
namespace MoviesAPI.Helpers
{
    public class AutoMapperProfiles: Profile
    {
        ...
        private object MapMoviesActors(MovieCreationDTO movieCreationDTO, Movie movie)
        {
        ...
        private object MapMovieTheatersMovies(MovieCreationDTO movieCreationDTO, Movie movie)
        {
